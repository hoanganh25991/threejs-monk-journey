...
/**
 * Effect for the Frigid Cyclone variant of Cyclone Strike
 * Creates an icy vortex that freezes enemies
 * Visual style: Swirling ice crystals and snowflakes
 */
export class FrigidCycloneEffect extends CycloneStrikeEffect {
    constructor(skill) {
        super(skill);
